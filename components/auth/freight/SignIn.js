...
import { login, verifyFreight } from "../../../actions/authCargo";
...
const SignIn = ({
  ...
  const { freightToken } = router.query;
  useEffect(() => {
    if (!freightToken) {
      return;
    }
    verifyFreight(freightToken, router);
  }, [freightToken]);
...
export default compose(
  connect(mapStateToProps, { login, verifyFreight }),
